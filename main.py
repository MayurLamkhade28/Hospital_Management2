...
app.include_router(hospital_router, tags=["Hospital_Router"])

app.include_router(technician_router, tags=["Technician_Router"])

app.include_router(reporting_doctor_router, tags=["Reporting_Doctor_Router"])

app.include_router(patient_router, tags=["Patient_Router"])

app.include_router(patient_file_router, tags=["Patient_file_Router"])

app.include_router(document_router, tags=["Document_Router"])

app.include_router(hospital_details_router, tags=["Hospital_Details_Router"])
